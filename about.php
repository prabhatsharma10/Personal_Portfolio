    ...
    <div class="container mx-auto px-6">
        ...
        <div class="grid lg:grid-cols-2 gap-12 items-center mb-16">
            ...
            <div class="text-center lg:text-left">
                <div class="relative inline-block">
                    <img src="assets/img/profile.jpeg" 
                         ...
                         class="w-80 h-80 rounded-2xl shadow-2xl object-cover mx-auto lg:mx-0">
                    <div class="absolute -bottom-6 -right-6 w-24 h-24 bg-gradient-to-br from-blue-600 to-purple-600 rounded-2xl flex items-center justify-center">
            ...
            <div class="space-y-6">
                ...
                <div class="grid grid-cols-2 gap-6 mt-8">
                    <div class="bg-gray-50 p-6 rounded-xl text-center hover:bg-blue-50 transition duration-300">
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <?php foreach ($highlights as $highlight): ?>
                <div class="bg-gray-50 p-8 rounded-xl text-center hover:bg-white hover:shadow-lg transition duration-300 transform hover:-translate-y-2">
