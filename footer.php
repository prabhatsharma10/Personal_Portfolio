    ...
    <div class="container mx-auto px-6 py-10">
        <div class="grid lg:grid-cols-4 md:grid-cols-2 gap-8">
            ...
            <div class="lg:col-span-1">
                ...
                <!-- Newsletter Signup bg-gray-800  rounded-lg -->
                <div class="p-1">
                    <h5 class="font-semibold mb-2">Get Updates</h5>
                    <p class="text-gray-400 text-sm mb-3">Subscribe to receive updates about new projects and articles.</p>
                    <form class="flex">
                        <input type="email"
                        ...
                        <button type="submit"
                            class="bg-blue-500 px-4 py-2 rounded-r-lg hover:from-blue-600 hover:to-purple-600 transition duration-300">
