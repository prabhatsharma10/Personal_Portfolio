...
$projects = [
    [
        ...
        'description' => 'A comprehensive admin dashboard for e-commerce management with real-time analytics, inventory tracking, and order management system.',
    ...
    [
        ...
        'description' => 'A full-featured social media platform with real-time messaging, post sharing, and advanced privacy controls.',
        'image' => 'assets/img/project2.jpg',
        'technologies' => ['Vue.js', 'PHP', 'MySQL', 'Socket.io'],
    ...
    [
        ...
        'description' => 'RESTful API service providing accurate weather forecasts with data visualization and location-based services.',
...
<section id="projects" class="py-20 bg-white">
    <div class="container mx-auto px-6">
        ...
        <div class="flex flex-wrap justify-center mb-12 gap-4">
            <button class="filter-btn active px-6 py-3 rounded-full border-2 border-blue-600 text-blue-600 bg-blue-50 hover:bg-blue-600 hover:text-white transition duration-300 font-semibold" 
                    data-filter="all">
                All Projects
            </button>
        ...
        <div class="mt-16 text-center">
            <div class="bg-gray-50 p-8 rounded-2xl max-w-2xl mx-auto">
